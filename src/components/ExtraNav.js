...
function ExtraNav() {
  ...
  return (
    <>
      <div
        onClick={navHandler}
        className="w-screen h-screen bg-white/0 fixed left-0 top-0"
      ></div>
      <div className="flex flex-col rounded-lg fixed xl:absolute top-0 left-2 xl:left-3 z-10 bg-white max-h-[100vh] shadow-md overflow-y-auto w-[230px]">
        <ExtraNavItem
          onClick={navHandler}
          temp
          text="Bookmarks"
